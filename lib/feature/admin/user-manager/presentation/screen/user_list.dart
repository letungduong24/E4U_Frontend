...
import 'package:e4uflutter/feature/admin/user-manager/presentation/widget/create_user_dialog.dart';
import 'package:e4uflutter/feature/admin/user-manager/presentation/widget/user_profile_dialog.dart';
...
class UserListScreen extends StatelessWidget {
    ...
    return HeaderScaffold(
      ...
      floatingButton: FloatingActionButton(
        onPressed: () => showDialog(
          context: context,
          builder: (context) => CreateUserDialog(controller: controller),
        ),
  ...
  String _getClassDisplay(UserManagementEntity user) {
  ...
  void _showUserDetails(BuildContext context, UserManagementEntity user) {
    showDialog(
      context: context,
